...
const tablesSchema = __schema({
  expense: __table({
    ...
    indexes: [
      ...
      { accessor: 'trip_id', name: 'expense_trip_id_idx_btree', algorithm: 'btree', columns: [
        'tripId',
      ] },
    ],
    constraints: [
  ...
  expense_split: __table({
    name: 'expense_split',
    indexes: [
      { accessor: 'debtor_id', name: 'expense_split_debtor_id_idx_btree', algorithm: 'btree', columns: [
        'debtorId',
      ] },
